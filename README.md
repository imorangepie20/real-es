...
- 한글 폰트 명시적 추가: 맥(Mac) 데스크탑 앱에서 명조체로 폴백되던 문제 해결 — layout.tsx에 **Noto Sans KR**(300/400/500/700) 추가, globals.css에 font-family 스택(Noto Sans KR + 시스템 폰트 + sans-serif) 명시, lang="en"→"ko". Geist는 Latin만 지원하므로 한글은 별도 폰트 필요.
