...
export const COLOR_TAGS: { value: ColorTagValue; label: string; dot: string; row: string }[] = [
  { value: "purple", label: "보라", dot: "bg-violet-500", row: "bg-violet-50 dark:bg-violet-950/40" },
  { value: "blue", label: "파랑", dot: "bg-blue-500", row: "bg-blue-50 dark:bg-blue-950/40" },
  { value: "orange", label: "주황", dot: "bg-orange-500", row: "bg-orange-50 dark:bg-orange-950/40" },
  { value: "gray", label: "회색", dot: "bg-gray-400", row: "bg-gray-100 dark:bg-gray-800/40" },
];
