...
export const COLOR_TAGS: { value: ColorTagValue; label: string; dot: string; row: string }[] = [
  { value: "purple", label: "보라", dot: "bg-violet-600", row: "bg-violet-100 dark:bg-violet-900/50" },
  { value: "blue", label: "파랑", dot: "bg-blue-600", row: "bg-blue-100 dark:bg-blue-900/50" },
  { value: "orange", label: "주황", dot: "bg-orange-600", row: "bg-orange-100 dark:bg-orange-900/50" },
  { value: "gray", label: "회색", dot: "bg-gray-500", row: "bg-gray-200 dark:bg-gray-800/60" },
];
