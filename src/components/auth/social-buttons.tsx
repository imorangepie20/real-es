...
export function SocialButtons() {
  return (
    <div className="grid grid-cols-3 gap-2">
      <Button variant="outline" size="default" className="w-full" type="button">
        {/* Google "G" */}
        <svg
          viewBox="0 0 24 24"
          className="size-4"
